...
const OnboardingLayout: React.FC = () => {
  ...
  const sidebarSteps = [
    ...
    { name: 'Pricing', icon: 'payments', path: '/add-homepage-7' },
    { name: 'House Rules', icon: 'gavel', path: '/add-homepage-8' },
  ];
      ...
      <div className="flex flex-1 pt-16 sm:pt-20">
        ...
        <nav className="hidden lg:flex flex-col fixed left-0 top-20 bottom-0 py-8 bg-surface border-r border-outline-variant h-full w-80 overflow-y-auto">
          <div className="px-6 mb-8">
            <p className="text-secondary text-sm font-medium mb-1">Step {currentStepIndex !== -1 ? currentStepIndex + 1 : 8} of 8</p>
