...
const AddHomePage4: React.FC = () => {
  ...
  const sidebarSteps = [
    { name: 'Property Type', icon: 'home_work', done: true },
    { name: 'Location', icon: 'location_on', done: true },
    { name: 'Basic Info', icon: 'info', done: true },
    { name: 'Amenities', icon: 'grid_view', done: false, active: true },
    { name: 'Photos', icon: 'photo_library', done: false },
    { name: 'Description', icon: 'description', done: false },
    { name: 'Pricing', icon: 'payments', done: false },
      ...
      <div className="flex flex-1 pt-16 sm:pt-20">
        ...
        <nav className="hidden lg:flex flex-col fixed left-0 top-20 bottom-0 py-8 bg-surface border-r border-outline-variant h-full w-80 overflow-y-auto">
          <div className="px-6 mb-8">
            <p className="text-secondary text-sm font-medium mb-1">Step 4 of 8</p>
